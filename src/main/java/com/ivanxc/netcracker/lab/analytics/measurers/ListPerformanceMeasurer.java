...
/**
 * Provides methods for measuring the performance of Lists.
 */

public class ListPerformanceMeasurer implements PerformanceMeasurer {
    private List<Object> list;

    public ListPerformanceMeasurer(List<Object> list) {
        this.list = list;
    }
